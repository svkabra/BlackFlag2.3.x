...
public class ReadXLSX {
      ...
      public  String[][] readExcel(String absolutePathToFile) {
              ...
              try {
                      ...
                      InputStream is = new BufferedInputStream(new FileInputStream(absolutePathToFile));
                      // Workbook representing the excel file
                      XSSFWorkbook wb = new XSSFWorkbook(is);
                      // Next a sheet which represents the sheet within that excel file
                      XSSFSheet sheet = wb.getSheet("Analytics");
   ...
   public int fnGetRowCount(String absolutePathToFile){
