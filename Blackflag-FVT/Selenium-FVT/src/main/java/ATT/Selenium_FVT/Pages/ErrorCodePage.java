...
public class ErrorCodePage extends WebPage {
	
	
	// Page Object "APIs"
	@FindBy(how = How.NAME, using="errorSearchInput")
	public WebElement errorSearch;
	
	@FindBy(how = How.LINK_TEXT, using = "Search")
	public WebElement searchButton;

	@FindBy(how = How.CLASS_NAME, using="errorCode")
	...
	public ErrorCodePage(WebDriver driver) {
		super(driver);
	...
	public void clkIndividualErrorCode(){	
		errorCode.click();
		waitForPageToLoad();
		implicitWait(2);
	...
	public void enterErrorCode(String errorCode){
		errorSearch.sendKeys(errorCode);
	}
